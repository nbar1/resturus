<div class="header_text">State Of The Art Renovations, Outstanding Service</div>
...
<ul>
	...
	<li>Granite - Silestone - Quartz</li>
	<li>Glamour Baths</li>
	<li>Custom Showers</li>
	<li>Ceramic Tile Flooring</li>
	<li>Marble Flooring</li>
	<li>Hardwood Flooring</li>
	<li>Custom Painting &amp; Wallpaper</li>
	<li>Custom Mirrors</li>
	<li>Electrical Upgrades</li>
	<li>Niches &amp; Shadowboxes </li>
	<li>Custom Interior Trim &amp; Moldings</li>
	<li>Custom Woodwork</li>
	<li>Crown Molding</li>
	<li>Functional Built-ins </li>
	<li>Decorative Columns</li>
	<li>Curved Archways</li>
	<li>Designer Ceilings</li>
	<li>Interior Door Replacement</li>
	<li>Coffer &amp; Domed Ceilings</li>
	<li>Ceiling Fans &amp; Lighting</li>
	<li>Plant Shelves</li>
	<li>Wainscoting</li>
	<li>Raised Paneled Wall</li>
</ul>