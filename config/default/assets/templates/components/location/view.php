...
<div class='Component_Location_Button_Call visible-phone intent_button'>
	<a href="tel://!{token://location_phone}" target="_blank"><button class="btn btn-block btn-large">Call Us</button></a>
</div>
<div class='Component_Location_Button_Directions !{token://maps_always_visible} intent_button'>
	<a href="http://maps.google.com/?q=!{token://location_url_encoded}" target="_blank"><button class="btn btn-block btn-large">Get Directions</button></a>
</div>